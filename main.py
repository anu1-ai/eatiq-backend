...
class Processor:
    def __init__(self):
        ...
        self.off_headers = {"User-Agent": "EatIQ/2.3 (https://eatiq.app)"}
...
@app.get("/")
async def health():
    return {"status": "ok", "service": "EatIQ Receipt Proxy",
            "version": "2.4", "model": "gpt-4o-mini",
            "parser": "two-pass-supermarket-aware",
            "image_detail": "auto",
