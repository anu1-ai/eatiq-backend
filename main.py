...
# ── Receipt word-abbreviation map ─────────────────────────────────────────────
# Supermarket receipts truncate individual words to fit ~20-char columns:
# "INOCENT BRY ENRG S" = Innocent Berry Energy Smoothie, "SENSATIN THAI SWT/C"
# = Sensations Thai Sweet Chilli. Expanding each token turns an unmatchable
# string into one the food database and OCR can resolve, which is the single
# biggest lever on nutrition accuracy. Keys are matched per-word,
# case-insensitively, whole-token only (so "BRY" won't touch "BERRY").
# Only unambiguous, common abbreviations are included — when in doubt, omit,
# because a wrong expansion is worse than leaving the token alone.
WORD_ABBREV = {
    # descriptors
    "swt": "sweet", "swt/c": "sweet chilli", "swtchil": "sweet chilli",
    "chil": "chilli", "chll": "chilli", "sr": "sriracha",
    "bry": "berry", "brry": "berry", "strwb": "strawberry", "straw": "strawberry",
    "rasp": "raspberry", "blueb": "blueberry", "blkcur": "blackcurrant",
    "enrg": "energy", "enr": "energy", "engy": "energy",
    "smth": "smoothie", "smoth": "smoothie", "smoo": "smoothie",
    "org": "organic", "orgnc": "organic", "wholemeal": "wholemeal", "wm": "wholemeal",
    "ww": "wholewheat", "whlml": "wholemeal", "wht": "white", "brn": "brown",
    "skmd": "skimmed", "s/skim": "semi skimmed", "sskim": "semi skimmed",
    "semi": "semi skimmed", "whl": "whole", "ss": "semi skimmed",
    "reduc": "reduced", "rdcd": "reduced", "lo": "low", "lofat": "low fat",
    "fatfr": "fat free", "lgt": "light", "lght": "light",
    "unsalt": "unsalted", "unslt": "unsalted", "sltd": "salted",
    "sgr": "sugar", "nas": "no added sugar", "s/f": "sugar free",
    "gf": "gluten free", "vgn": "vegan", "veg": "vegetable", "vegs": "vegetables",
    "frzn": "frozen", "frsh": "fresh", "rst": "roast", "rstd": "roasted",
    "smk": "smoked", "smkd": "smoked", "grl": "grilled", "bbq": "barbecue",
    "crm": "cream", "crmy": "creamy", "choc": "chocolate", "choco": "chocolate",
    "choc/c": "chocolate chip", "vanil": "vanilla", "van": "vanilla",
    "carml": "caramel", "carm": "caramel", "hncmb": "honeycomb",
    # proteins / dairy
    "chk": "chicken", "chkn": "chicken", "chick": "chicken", "chic": "chicken",
    "brst": "breast", "thgh": "thigh", "mnc": "mince", "mncd": "minced",
    "bf": "beef", "prk": "pork", "lmb": "lamb", "ssg": "sausage", "sausg": "sausage",
    "bcn": "bacon", "gmn": "gammon", "trky": "turkey",
    "sal": "salmon", "slmn": "salmon", "tun": "tuna", "prwn": "prawn", "prawns": "prawns",
    "cod": "cod", "haddk": "haddock", "mussl": "mussels", "mussels": "mussels",
    "chdr": "cheddar", "chddr": "cheddar", "chs": "cheese", "chse": "cheese",
    "mozz": "mozzarella", "parm": "parmesan", "leic": "leicester",
    "yog": "yogurt", "yght": "yogurt", "yogrt": "yogurt", "yg": "yogurt",
    "mlk": "milk", "buttr": "butter", "btr": "butter", "marg": "margarine",
    "egg": "eggs", "eggs": "eggs",
    # bakery / grains
    "brd": "bread", "bagte": "baguette", "bagett": "baguette", "bag": "baguette",
    "rl": "roll", "rls": "rolls", "brioch": "brioche", "crmpt": "crumpet",
    "muff": "muffin", "crssnt": "croissant", "pta": "pitta", "trtla": "tortilla",
    "ptt": "pitta", "crckr": "cracker", "crkbrd": "crackerbread",
    "shrtbrd": "shortbread", "bisct": "biscuit", "bisc": "biscuit",
    "past": "pasta", "spag": "spaghetti", "noodl": "noodle", "ndl": "noodle",
    "rce": "rice", "bsmti": "basmati", "cous": "couscous",
    "cereal": "cereal", "porr": "porridge", "grnla": "granola", "musli": "muesli",
    # produce
    "ban": "banana", "banan": "banana", "app": "apple", "appl": "apple",
    "orng": "orange", "grp": "grape", "grps": "grapes", "strwbs": "strawberries",
    "tom": "tomato", "toms": "tomatoes", "tmto": "tomato", "cuc": "cucumber",
    "let": "lettuce", "lettu": "lettuce", "brocc": "broccoli", "brocol": "broccoli",
    "carr": "carrot", "carrt": "carrot", "onin": "onion", "pot": "potato",
    "pots": "potatoes", "potat": "potato", "ptato": "potato", "mush": "mushroom",
    "mushr": "mushroom", "pepp": "pepper", "ppr": "pepper", "avo": "avocado",
    "spin": "spinach", "spnch": "spinach", "cabg": "cabbage", "caulif": "cauliflower",
    "corg": "courgette", "aubr": "aubergine", "asparg": "asparagus",
    # drinks
    "jce": "juice", "jc": "juice", "orngj": "orange juice", "aplj": "apple juice",
    "wtr": "water", "sprkl": "sparkling", "sqsh": "squash", "cordl": "cordial",
    "lmnd": "lemonade", "col": "cola", "diet": "diet", "zero": "zero",
    "cffe": "coffee", "cof": "coffee", "te": "tea", "grnt": "green tea",
    "lgr": "lager", "ale": "ale", "cdr": "cider", "wne": "wine",
    "red": "red", "wht/wine": "white wine", "prsc": "prosecco", "champ": "champagne",
    # snacks / sweets
    "crsp": "crisps", "crisps": "crisps", "crsps": "crisps", "chips": "crisps",
    "poppd": "popped", "nut": "nuts", "nts": "nuts", "cashw": "cashew",
    "penut": "peanut", "pnut": "peanut", "alm": "almond", "almnd": "almond",
    "choco": "chocolate", "chocbar": "chocolate bar", "cbar": "chocolate bar",
    "swts": "sweets", "gum": "gum", "mint": "mints", "toff": "toffee",
    "icecr": "ice cream", "ic/cr": "ice cream", "gelt": "gelato", "srbt": "sorbet",
    "cak": "cake", "ck": "cake", "brwn": "brownie", "dnut": "doughnut",
    # condiments / cooking
    "sauc": "sauce", "sce": "sauce", "ketchp": "ketchup", "mayo": "mayonnaise",
    "mustd": "mustard", "vin": "vinegar", "balsam": "balsamic", "oil": "oil",
    "olv": "olive", "ol/oil": "olive oil", "veg/oil": "vegetable oil",
    "spre": "spread", "jm": "jam", "mrmld": "marmalade", "hny": "honey",
    "stk": "stock", "grvy": "gravy", "curry": "curry", "madras": "madras",
    "korma": "korma", "tikka": "tikka", "pesto": "pesto",
    "beans": "beans", "bkd": "baked", "chkpea": "chickpea", "lentl": "lentil",
    "houms": "hummus", "hmus": "hummus",
    # ready / frozen
    "pizz": "pizza", "pzza": "pizza", "lasg": "lasagne", "lasagn": "lasagne",
    "shphrd": "shepherds", "cottg": "cottage", "rdy": "ready", "ml": "meal",
    "fllt": "fillet", "fingrs": "fingers", "nugg": "nuggets", "wedg": "wedges",
    "wasabi": "wasabi",
    "grk": "greek", "grek": "greek", "nat": "natural", "pln": "plain",
    "pstch": "pistachio", "hazl": "hazelnut", "cocnt": "coconut", "cocon": "coconut",
    "digst": "digestive", "hobnb": "hobnob", "flpjk": "flapjack",
    "pnc": "pancake", "wffl": "waffle", "crmb": "crumble", "custd": "custard",
    "trfl": "trifle", "mousse": "mousse", "chsecke": "cheesecake",
    "sndwch": "sandwich", "wrp": "wrap", "pnini": "panini", "quiche": "quiche",
    "cvr": "cover", "prtn": "protein", "protn": "protein",
    # generic units/qty tokens handled elsewhere; kept out here
}
...
def decode_abbreviations(raw: str) -> str:
    ...
    # Per-word abbreviation expansion. Runs last so brand/store prefixes are
    # already handled. Each whitespace token is looked up whole (case-
    # insensitive); unknown tokens pass through untouched. This turns
    # "INOCENT BRY ENRG S" into "Innocent berry energy" etc., dramatically
    # improving database match rate and readability.
    def _expand_token(tok):
        low = tok.lower()
        if low in WORD_ABBREV:
            return WORD_ABBREV[low]
        # strip trailing punctuation for the lookup, re-attach nothing
        stripped = low.strip('.,/')
        if stripped in WORD_ABBREV:
            return WORD_ABBREV[stripped]
        return tok
    if text:
        text = ' '.join(_expand_token(t) for t in text.split())
    text = re.sub(r'\s{2,}', ' ', text).strip()
    return text

def extract_pack_qty(name: str):
    """Detect a multipack count so weight/nutrition can be scaled.
    Matches 'x5', '5x', 'x 5', '5 PACK', '5PK', '5-PACK', '6 PK'.
    Returns (clean_name, qty) where qty defaults to 1. Only counts 2..99 to
    avoid mistaking a weight ('500') or a stray digit for a pack size."""
    qty = 1
    patterns = [
        r'\bx\s*(\d{1,2})\b',        # x5, x 5
        r'\b(\d{1,2})\s*x\b',        # 5x
        r'\b(\d{1,2})\s*[-\s]?pack\b',  # 5 pack, 5-pack
        r'\b(\d{1,2})\s*pk\b',       # 5pk, 5 pk
    ]
    clean = name
    for pat in patterns:
        ...
        if mm:
            ...
            if 2 <= n <= 99:
                qty = n
                clean = re.sub(pat, '', clean, count=1, flags=re.IGNORECASE).strip()
                break
...
def parse_receipt_lines(raw_text: str) -> List[Dict]:
    ...
    _prev_bare_price = None    # a price on its own line — candidate grand total
    ...
    for line in item_lines:
        ...
        # Matches 'TOTAL', 'BALANCE DUE', 'AMOUNT DUE', 'TOTAL DUE', 'TO PAY'.
        # The LAST such total on the receipt wins (receipts print interim
        # totals before coupons). 'total savings'/'sub total' are excluded.
        is_total_line = (
            (re.search(r'\btotal\b', line_lower) and 'sub' not in line_lower and 'saving' not in line_lower)
            or re.search(r'\bbalance\s+due\b', line_lower)
            or re.search(r'\bamount\s+due\b', line_lower)
            or re.search(r'\bto\s+pay\b', line_lower)
        )
        if is_total_line:
            mt = re.search(r'(\d{1,4}[.,]\d{2})\s*$', line)
            if mt:
                try:
                    receipt_total = normalise_decimal(mt.group(1))
                except ValueError:
                    pass
            last_was_item = False
            _prev_bare_price = None
            continue
        ...
        if should_strip(line):
            # If this stripped line is a payment/balance marker and we have a
            # bare price from just before it, that bare price is the grand total.
            if _prev_bare_price is not None and receipt_total is None and \
               re.search(r'balance|due|visa|debit|credit|cash|card|contactless|mastercard|paid|change', line_lower):
                receipt_total = _prev_bare_price
            pending_name = None
            last_was_item = False
            _prev_bare_price = None
            continue
        ...
        if price is not None and name_raw:
            ...
            if pending_name:
                ...
                # A price on its own line with no name. On many receipts the
                # grand total is printed as a bare price immediately before a
                # 'BALANCE DUE'/'Visa Debit' line. Remember it; if a payment or
                # balance line follows, we treat it as the total (handled at the
                # top of the loop / by should_strip). Otherwise it's ignored.
                _prev_bare_price = price
                last_was_item = False
                continue
...
def _apply_basket_discounts(items: List[Dict], pooled: float, receipt_total: Optional[float]):
    """
    Handle basket-level discounts WITHOUT distorting individual item prices.

    Design principle: each item keeps its real face value (the shelf price,
    after any line-level discount that clearly attached to it). Basket-wide
    promotions — meal deals, whole-basket coupons, multibuys that can't be
    tied to one item — are NOT smeared across items, because that produces
    wrong per-item prices (e.g. showing Ferrero Rocher as £6.43 when it cost
    £7.50). Spend is reported from the printed receipt_total separately, so
    item prices do not need to be forced to sum to it.

    We only reconcile item prices in ONE safe case: when the item sum EXCEEDS
    the printed total by more than the known pooled discount — that residual
    is an over-read (e.g. a price misread high), and proportional trimming of
    the residual is the least-bad correction. The pooled discount itself is
    left as basket-level metadata, not pushed onto items.
    """
    if not items:
        return
    current_sum = round(sum(i["price"] for i in items), 2)
    if current_sum <= 0:
        return

    if receipt_total is None:
        # No authoritative total — leave face-value prices untouched. The
        # pooled discount is reported separately as basket metadata.
        return

    gap = round(current_sum - receipt_total, 2)
    # The gap we EXPECT from basket-level discounts we already pooled:
    expected_gap = round(pooled, 2)
    residual = round(gap - expected_gap, 2)

    # If the residual is tiny, the face-value prices are correct and the gap
    # is fully explained by the pooled basket discount — leave prices as-is.
    if abs(residual) <= 0.05:
        logger.info(f"Item prices kept at face value; £{expected_gap:.2f} basket "
                    f"discount reported separately (sum £{current_sum:.2f}, "
                    f"total £{receipt_total:.2f}).")
        return

    # A meaningful residual means item prices don't reconcile even after known
    # discounts — likely an OCR misread on one or more prices. Trim only the
    # residual, proportionally, so the visible prices are at least internally
    # consistent with the receipt total.
    if residual > 0:
        factor = (current_sum - residual) / current_sum
        for i in items:
            i["price"] = round(i["price"] * factor, 2)
        logger.info(f"Trimmed £{residual:.2f} residual (likely OCR over-read) "
                    f"proportionally after accounting for £{expected_gap:.2f} discount.")
        # Fix rounding drift on the priciest item
        target = round(current_sum - residual, 2)
    ...
    # residual < 0 means items sum to LESS than (total − discount): OCR missed
    # a line. We leave prices as-is; the missing_value flag surfaces this.
...
def _add_item(items: List[Dict], name_raw: str, price: float):
    ...
    name_nopack, pack_qty = extract_pack_qty(name_decoded)
    name_clean, weight = extract_weight(name_nopack)
    ...
    items.append({
        ...
        "weight":     weight,
        "pack_qty":   pack_qty,     # multipack count (1 if single)
        "price":      price,
        "category":   category,
